    ...
    >
      ...
      <div className="container-custom relative z-10">
        ...
        >
          ...
          <h2 className="font-grotesk font-bold text-4xl md:text-5xl lg:text-6xl text-slate-900 dark:text-white mt-6">
            Results That{" "}
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#007AFF] to-[#5AC8FA]">Speak</span> for Themselves
          </h2>
        </motion.div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-6">
          {stats.map((stat, i) => (
            <motion.div
              ...
              className="bg-white dark:bg-[#131524] shadow-[0_4px_24px_rgba(0,0,0,0.04)] border border-slate-100 dark:border-slate-800 rounded-2xl md:rounded-3xl p-6 md:p-8 text-center relative overflow-hidden group"
            ...
            >
              ...
              <div className="font-grotesk font-bold text-slate-900 dark:text-white text-sm md:text-base mb-1">
                {stat.label}
              </div>
              <div className="text-slate-500 dark:text-slate-400 font-jakarta text-xs">{stat.sublabel}</div>
