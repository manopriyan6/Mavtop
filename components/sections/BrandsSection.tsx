...
const brands = [
  { 
    srcLight: "/client logo/logo-final.png", 
    srcDark: "/client logo/logo-final copy.png", 
    alt: "Client Logo 1" 
  },
  { 
    ...
    <div className="w-full mt-auto pt-10 pb-6 relative z-20">
      <div className="container-custom">
        ...
        <div className="relative flex overflow-hidden group">
          ...
          {/* Scrolling Track */}
          <div className="flex items-center space-x-12 md:space-x-24 animate-marquee whitespace-nowrap">
            {/* First Set */}
            {brands.map((brand, i) => (
              <div 
                key={`brand-1-${i}`} 
                className="relative w-40 h-14 flex items-center justify-center cursor-default"
              >
